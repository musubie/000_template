...
# Block Uncomment Script - Uncomments import/export statements
# Usage: perl blkuc.pl file1.js file2.js ...
...
for my $file (@ARGV) {
    ...
    # Apply block uncomment transformations
